...
export MODEL_BUCKET_PROD="stg-mlartifact-s3-mlops-zoomcamp"
...
# Model artifacts bucket from the previous weeks (MLflow experiments saved model)
export MODEL_BUCKET_DEV="mlartifact-s3"
